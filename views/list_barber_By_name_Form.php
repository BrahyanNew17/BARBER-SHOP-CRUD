...
<div class="container" style="padding-top: 100px;">
    ...
    <h2 class="titulo mb-4">Buscar Barbero por Nombre</h2>

    <div class="row justify-content-center mb-4">
        <div class="col-12 col-sm-10 col-md-8 col-lg-6">
            <form class="form-eliminar" action="index.php?action=searchBarberByName" method="POST">
            ...
            <form action="index.php?action=searchBarberByName" method="POST" style="margin-top:10px;">
