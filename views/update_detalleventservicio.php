...
<head>
    ...
    <title>Actualizar Detalle Venta Servicio</title>
...
<div class="container py-4" style="max-width:600px; margin:0 auto;">
    ...
    <h2 class="titulo mb-4">Actualizar Detalle Venta Servicio</h2>
    ...
    <form action="index.php" method="POST" class="mb-4">
        <input type="hidden" name="action" value="searchDetalleVentServicioByIdForUpdate">
        <div>
            <label style="color:#d4af37; font-weight:600; display:block; margin-bottom:6px;">
                Buscar por ID Detalle:
            </label>
            <input type="text" name="idDetalle" placeholder="Ingrese ID Detalle" required
    ...
    <?php if (isset($_POST['idVentaServi']) && empty($detalles)): ?>
    ...
    <?php if (!empty($detalles)): ?>
        ...
        <div class="mb-4 p-4" style="background:#181818; border:1px solid #d4af37; border-radius:12px;">
            <form action="index.php?action=actualizarDetalleVentServicio" method="post">
                <input type="hidden" name="action" value="actualizarDetalleVentServicio">
                <input type="hidden" name="idDetalle" value="<?= htmlspecialchars($detalle['idDetalle']) ?>">
                <input type="hidden" name="idServicio" value="<?= htmlspecialchars($detalle['idServicio']) ?>">
                <input type="hidden" name="idVentaServi" value="<?= htmlspecialchars($detalle['idVentaServi']) ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" value="<?= htmlspecialchars($detalle['nombreServi']) ?>"
                        readonly
    ...
    <?php else: ?>
        ...
        <div class="mb-4 p-3 d-flex align-items-center gap-3"
            ...
            <span style="font-weight:600;">Ingresa un ID para buscar y editar un detalle de venta servicio.</span>
        </div>
        </center>
    <?php endif; ?>
