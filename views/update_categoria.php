...
<div class="container py-4" style="max-width:600px; margin:0 auto;">
    ...
    <h2 class="titulo mb-4">Actualizar Categorías</h2>
    ...
    <form action="index.php" method="POST" class="mb-4">
        <input type="hidden" name="action" value="searchCategoriaByName">
        <div>
            <label style="color:#d4af37; font-weight:600; display:block; margin-bottom:6px;">
                Buscar por Categoría:
            </label>
            <input type="text" name="categoria" placeholder="Ingrese categoría" required
            ...
            <button type="submit" class="btn-dashboard">Buscar Categoría</button>
        </div>
    </form>

    <?php if (isset($_POST['categoria']) && empty($categorias)): ?>
        <div class="mb-4 p-3" style="background:#3a1a1a; color:#f44336; border:1px solid #f44336; border-radius:8px;">
            <strong>✗ No se encontró esa categoría.</strong>
        </div>
    <?php endif; ?>
        ...
        <div class="mb-4 p-4" style="background:#181818; border:1px solid #d4af37; border-radius:12px;">
            <form action="index.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="categoria" value="<?= htmlspecialchars($categoria['categoria']) ?>"
                        required
                        style="background:#232323; color:#fff; border:1px solid #d4af37; border-radius:7px; padding:8px 10px; width:100%;">
                </div>

                <button type="submit" class="btn-dashboard w-100">Actualizar Categoría</button>
            </form>
        </div>
        <?php endforeach; ?>
    ...
    <?php else: ?>
        ...
        <div class="mb-4 p-3 d-flex align-items-center gap-3"
            ...
            <span style="font-weight:600;">Ingresa una categoría para buscarla y editarla.</span>
        </div>
        </center>
    <?php endif; ?>
