...
<head>
    ...
    <title>Actualizar Venta Producto</title>
...
<div class="container py-4" style="max-width:600px; margin:0 auto;">
    ...
    <h2 class="titulo mb-4">Actualizar Venta Producto</h2>
    ...
    <form action="index.php" method="POST" class="mb-4">
        <input type="hidden" name="action" value="searchVentaProductoByIdForUpdate">
        <div>
    ...
    <?php if (isset($_POST['idVentaProducto']) && empty($ventas)): ?>
    ...
    <?php if (!empty($ventas)): ?>
        ...
        <div class="mb-4 p-4" style="background:#181818; border:1px solid #d4af37; border-radius:12px;">
            <form action="index.php?action=actualizarVentaProducto" method="post">
                <input type="hidden" name="action" value="actualizarVentaProducto">
                <input type="hidden" name="idVentaProducto" value="<?= htmlspecialchars($venta['idVentaProducto']) ?>">

                <div class="mb-3">
                    <label style="color:#d4af37; font-weight:600; display:block; margin-bottom:6px;">Fecha:</label>
                    <input type="date" name="fecha" value="<?= htmlspecialchars($venta['fecha']) ?>"
                        required
                ...
                <div class="mb-3">
                    ...
                    <input type="time" name="hora" value="<?= htmlspecialchars($venta['hora']) ?>"
                        required
                        style="background:#232323; color:#fff; border:1px solid #d4af37; border-radius:7px; padding:8px 10px; width:100%;">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="total" value="<?= htmlspecialchars($venta['total']) ?>"
                        step="0.01" required
                        style="background:#232323; color:#fff; border:1px solid #d4af37; border-radius:7px; padding:8px 10px; width:100%;">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" value="<?= htmlspecialchars($venta['nombreComplet'] ?? '') ?>"
                        readonly
                        style="background:#2a2a2a; color:#aaa; border:1px solid #555; border-radius:7px; padding:8px 10px; width:100%;">
                </div>

                <button type="submit" class="btn-dashboard w-100">Actualizar Venta</button>
            </form>
        </div>
        <?php endforeach; ?>
         <?php else: ?>
        ...
        <div class="mb-4 p-3 d-flex align-items-center gap-3"
            ...
            <span style="font-weight:600;">Ingresa un nombre para buscar y editar una venta de producto.</span>
        </div>
        </center>
    <?php endif; ?>
