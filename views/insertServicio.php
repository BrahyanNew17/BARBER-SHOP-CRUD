...
<div class="container" style="padding-top: 150px;">
    ...
    <h1 class="titulo mb-4">Insertar Servicio</h1>

    <div class="row justify-content-center">
        <div class="col-12 col-sm-10 col-md-8 col-lg-6">
            <form class="form-eliminar" action="index.php?action=insertServicio" method="POST" enctype="multipart/form-data">

                <label>Nombre del Servicio:</label>
                <input type="text" name="nombreServi" required>

                <label>Precio Unitario:</label>
                <input type="number" name="precioUni" min="0" required>

                <label>Duración:</label>
                <input type="text" name="duracion" placeholder="Ej: 30 Minutos" required>
