...
$sqlCats = "SELECT idCategoria, categoria FROM categoria ORDER BY categoria ASC";
        ...
        <aside class="sidebar">
            ...
            <ul>
                <?php foreach ($categorias as $cat): ?>
                    <li>
                        <a href="index.php?action=categoria&id=<?= $cat['idCategoria'] ?>"
            ...
            <div class="container mt-4">
                <div class="row" id="contenedorProductos">
                    ...
                    <?php foreach ($productos as $p): ?>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 producto-item"
                ...
                cartItemsContainer.innerHTML += `
                    <div class="cart-item">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-3 mb-2 mb-md-0 d-flex align-items-center justify-content-between justify-content-md-start">
                                ...
                                <div class="subtotal-price d-md-none ms-auto">
...
<footer class="footer">
        <p class="footer-text">&copy; 2026 <span>Barber Shop&reg;</span> &mdash; Todos los derechos reservados</p>
