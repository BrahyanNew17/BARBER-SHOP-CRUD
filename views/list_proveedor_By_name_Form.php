...
<div class="container" style="padding-top: 100px;">
    ...
    <h2 class="titulo mb-4">Buscar Proveedor por Nombre</h2>

    <div class="row justify-content-center mb-4">
        <div class="col-12 col-sm-10 col-md-8 col-lg-6">
            <form class="form-eliminar" action="index.php?action=searchProveedorByName" method="POST">
        ...
        <div class="tabla-responsive">
            <table class="w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= htmlspecialchars($proveedor["NITproveedor"]) ?></td>
                        <td><?= htmlspecialchars($proveedor["nombreProveedor"]) ?></td>
                        <td class="d-none d-md-table-cell"><?= htmlspecialchars($proveedor["direcProveedor"]) ?></td>
                        <td class="d-none d-md-table-cell"><?= htmlspecialchars($proveedor["telefono"]) ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        </div>
    <?php elseif (isset($proveedors)): ?>
        <div style="background:#1a1a1a; border:2px solid #d4af37; border-radius:10px; padding:15px; text-align:center; margin-bottom:20px;">
            <p style="color:#d4af37; margin:0;">⚠️ No se encontraron proveedores con ese nombre.</p>
        </div>
    <?php endif; ?>
