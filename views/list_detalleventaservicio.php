...
<head>
    ...
    <title>Detalle Venta Servicio</title>
...
<div class="container py-4">
    ...
    <h2 class="titulo mb-4">Detalle Venta Servicio</h2>
        ...
        <table class="w-100">
            <thead>
                <tr>
                    ...
                    <th class="d-none d-md-table-cell">Venta Servicio</th>
                    <th>Fecha</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-none d-md-table-cell"><?= htmlspecialchars($detalle['idVentaServi']) ?></td>
